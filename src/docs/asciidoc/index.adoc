...
.request
include::{snippets}/api/v1/member/me/http-request.adoc[]

.response
include::{snippets}/api/v1/member/me/http-response.adoc[]

.response fields
include::{snippets}/api/v1/member/me/response-fields.adoc[]
