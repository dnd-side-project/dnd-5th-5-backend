...
== POST /api/v1/alacard/wordlist

.request
include::{snippets}/api/v1/alacard/wordlist/post/http-request.adoc[]

.request fields
include::{snippets}/api/v1/alacard/wordlist/post/request-fields.adoc[]

.response
include::{snippets}/api/v1/alacard/wordlist/post/http-response.adoc[]

.response fields
include::{snippets}/api/v1/alacard/wordlist/post/response-fields.adoc[]
