...
== GET /api/v1/member/me/friends

.request
include::{snippets}/api/v1/member/me/friends/http-request.adoc[]

.response
include::{snippets}/api/v1/member/me/friends/http-response.adoc[]

.response fields
include::{snippets}/api/v1/member/me/friends/response-fields.adoc[]
